...
export default function App() {
  const handleClick = () => {console.log("I clicked the button")}; 
  return <Button color="green" disabled={false} text="This is a button" handleClick2={handleClick}/>; 
}
//2.
// ... inside return <Button [...] onClick2={() => {console.log("I clicked the button"); alert('You clicked me!')}}/>
// {} in arrow-function bc of 2 returns in it!!
// onClick2 can be named however we want
// console.log("xxx") -> value of expression inside console.log is ALWAYS undefined -> onClick2=console.log("I clicked") doesnt work

function Button ( {color, disabled, text, handleClick2} ) {
  // 3. const handleClick = () => {console.log("I clicked the button")};
  return (
    <button 
      //2. onClick={onClick2} --> onClick2 as a prop inside function Button ({})  
